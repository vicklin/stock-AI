...
import cn.iyowei.stockai.service.StockTagService;
...
public class StockTagController extends BaseRestSpringController {
     ...
     */
    @RequestMapping
    public DataMap list(StockTagQuery query) {
        DataMap dataMap = new DataMap();
        try {
            Map<String, Set> searchResult = stockTagService.serach(query);
    ...
    public DataMap searchByKey(@PathVariable String key) {
        DataMap dataMap = new DataMap();
        try {
            List<Stock> stocks = stockTagService.findStocksByKey(key);
