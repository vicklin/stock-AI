package cn.iyowei.stockai.jdbc.support;
 ...
 * @author badqiu
 */
public class OffsetLimitResultSetExtractor implements ResultSetExtractor<Object> {
    private int limit;
    private int offset;
    ...
    public Object extractData(ResultSet rs) throws SQLException, DataAccessException {
        List<Object> results = new ArrayList<Object>(limit > 50 ? 50 : limit);
