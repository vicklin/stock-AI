...
package cn.iyowei.stockai.rest;
...
public class DataMap extends LinkedHashMap<String, Object> {
     ...
     * @see #addAttribute(Object)
     */
    public DataMap addAllAttributes(Collection<?> attributeValues) {
     ...
     * @see #addAttribute(String, Object)
     */
    public DataMap addAllAttributes(Map<String, ?> attributes) {
        if (attributes != null) {
            putAll(attributes);
        }
        return this;
     ...
     * replaced).
     */
    public DataMap mergeAttributes(Map<String, ?> attributes) {
        if (attributes != null) {
